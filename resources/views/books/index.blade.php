...
@section('content')
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 sm:mb-8">
            ...
            <a href="{{ route('books.create') }}" class="btn-primary w-full sm:w-auto inline-flex items-center justify-center">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors group">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <a href="{{ route('books.show', $book) }}" class="btn-primary btn-sm inline-flex items-center justify-center">
                                        ...
                                        <a href="{{ route('books.edit', $book) }}" class="btn-secondary btn-sm inline-flex items-center justify-center">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <form action="{{ route('books.destroy', $book) }}" method="POST" class="inline-block"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn-danger btn-sm inline-flex items-center justify-center">
                                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
