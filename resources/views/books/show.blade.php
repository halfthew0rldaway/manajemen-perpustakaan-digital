        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-lg text-gray-600 dark:text-gray-400">oleh {{ $book->author }}</p>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-6">Informasi Buku</h2>

                    <dl class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Penulis</dt>
                            <dd class="mt-1 text-base text-gray-900 dark:text-white">{{ $book->author }}</dd>
                        </div>

                        <div>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Penerbit</dt>
                            <dd class="mt-1 text-base text-gray-900 dark:text-white">{{ $book->publisher ?? '-' }}</dd>
                        </div>

                        <div>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Tahun Terbit</dt>
                            <dd class="mt-1 text-base text-gray-900 dark:text-white">{{ $book->publication_year ?? '-' }}
                            </dd>
                        </div>

                        <div>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">ISBN</dt>
                            <dd class="mt-1 text-base text-gray-900 dark:text-white font-mono">{{ $book->isbn ?? '-' }}</dd>
                        </div>
                        ...
                        <div>
                            ...
                            <dd class="mt-1">
                                @if($book->category)
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-sky-100 text-sky-700 dark:bg-sky-900/50 dark:text-sky-300">
                                        {{ $book->category }}
                                    </span>
                                @else
                        ...
                        <div>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Stok Tersedia</dt>
                            <dd class="mt-1">
                                <span
                    ...
                    @if($book->description)
                        <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <dd class="text-base text-gray-900 dark:text-white leading-relaxed">{{ $book->description }}</dd>
                        </div>
                    @endif
                </div>
                ...
                <div
                    class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-6">Riwayat Peminjaman</h2>
                    ...
                    @else
                        <p class="text-gray-500 dark:text-gray-400 text-center py-8">Belum ada riwayat peminjaman</p>
                    @endif
                </div>
            </div>
            ...
            <div class="space-y-6">
                <!-- Stock Status -->
                <div class="bg-violet-400 dark:bg-violet-600 rounded-xl shadow-lg p-6 text-white">
                ...
                <div
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-xl font-bold text-gray-900 dark:text-white">{{ $book->loans->count() }}</span>
                        </div>

                        <div class="flex items-center justify-between">
                            <span class="text-gray-600 dark:text-gray-400">Peminjaman Aktif</span>
                            <span
                                class="text-xl font-bold text-teal-600 dark:text-teal-400">{{ $book->activeLoans()->count() }}</span>
                        </div>

                        <div class="flex items-center justify-between">
                            <span class="text-gray-600 dark:text-gray-400">Sudah Dikembalikan</span>
                            <span
                                class="text-xl font-bold text-gray-600 dark:text-gray-400">{{ $book->loans->where('status', 'returned')->count() }}</span>
                        </div>
                    </div>
                </div>
